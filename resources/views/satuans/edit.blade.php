                ...
                <div class="col-md-6 col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-horizontal" action="{{ route('satuan.update', $satuan->id) }}""
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 form-group">
                                                <input type="text" id="satuan" value="{{ $satuan->satuan }}"
                                                    class="form-control" name="satuan" placeholder="satuan">
                                            </div>
                                            <div class="col-md-4">
                                                <label for="email-horizontal">Catatan : </label>
                                            </div>
                                            <div class="col-md-8 form-group">
                                                <input type="text" id="catatan" value="{{ $satuan->catatan }}"
